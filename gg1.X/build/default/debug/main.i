...
void statusReport(){
    ...
    sendString("////////////////////////////////////////////////////////////////////////////////\n");
    sendString("////////\n");
    sprintf(buffer, "////////   Current Speed: %f  \n", v);
    sendString(buffer);
    sendString("////////\n");
    sprintf(buffer, "////////   Current Position: %d  \n", x);
    sendString(buffer);
    sendString("////////\n");
    sprintf(buffer, "////////   Warning Level: %d  \n", level);
    sendString(buffer);
    sendString("////////\n");
    ...
    while (1)
    {
        ...
        if(EUSART1_is_rx_ready())
        {
            ...
            if (temp == 'i') {
                ...
                h = 'i';
                I2C1_MasterWrite(&h, length, 0x08, &w_status);
                I2C1_MasterRead(&x, length, 0x08, &p_status);
                if((int)x != 0){
                    sendString("command received");
                    sendString("\n");
                }
            } else if (temp == 'd'){
                ...
                I2C1_MasterRead(&x, length, 0x08, &p_status);
                while(p_status != I2C1_MESSAGE_COMPLETE);
                sendString(x);
                sendString("\n");
